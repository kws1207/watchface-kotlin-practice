...
class AnalogWatchCanvasRenderer(
    ...
    override fun render(
        ...
        val centerY = bounds.width() * (watchFaceData.gapBetweenOuterCircleAndBorderFraction + watchFaceData.numberRadiusFraction)
        canvas.drawText("${zonedDateTime.hour}:${zonedDateTime.minute}", centerX, centerY/2, textPaint)
    }
